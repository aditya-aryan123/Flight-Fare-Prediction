...
def run():
    ...
    model = lgbm.LGBMRegressor(num_iterations=1000, max_depth=10, learning_rate=0.05, min_data_in_leaf=2,
                               min_gain_to_split=0.7, min_sum_hessian_in_leaf=2.0, num_leaves=20, bagging_fraction=0.9,
                               bagging_freq=1, lambda_l1=50, lambda_l2=8)
    ...
    print(f"Root Mean Squared Error Train: {rmse_train}, R Squared Train: {r2_score_train}, Mean Absolute Error Train: {mae_train}")
    print(f"Root Mean Squared Error Test: {rmse_test}, R Squared Test: {r2_score_test}, Mean Absolute Error Test: {mae_test}")
